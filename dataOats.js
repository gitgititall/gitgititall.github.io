...
{AIM: ' Develop new business opportunities', 
	...
	{OBJ: '0 next level - be able to do the next two levels of work ((next level))',
		TAS:[
			'??',
		]
	},
...
{AIM: ' Speak and write about my ideas', 
	...
	{OBJ: '16 read 10 books and attend safari conferences. ((Be most informed to get the edge. Know at research level about banking technology architecture (pma). Read a lot!))',
		TAS:[
	...
	{OBJ: '16 Build a Cordova App on macbook - base for digital',
		TAS:[
		'5am on weekend',
		]},
	{OBJ: '20 Master Docker basics, deliver talk',
		TAS:[
